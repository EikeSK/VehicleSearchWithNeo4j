...
public class VehicleDataHelperTest {
    ...
    public void fillDatabaseWithVehicleData() throws Exception {
        ...
        batch.put(vehicleModelWithName("VW Golf 6 Kombi"), new HashSet<>(Arrays.asList(metaDataWith("2008", "Baujahr"), metaDataWith("2012", "Baujahr"), metaDataWith("diesel"), metaDataWith("benzin"))));
